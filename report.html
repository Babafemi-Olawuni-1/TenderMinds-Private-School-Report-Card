...
<img src="img/lg2.jpg" height="150px" float="left"/><h1 style="text-align:center;font-family:ar julian;font-size:35px;text-transform:uppercase" class="text-danger qp">Tender Minds Private School </h1>
